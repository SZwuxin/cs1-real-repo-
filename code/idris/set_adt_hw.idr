...
list_cardinality: (s: list a) -> nat
list_cardinality nil = O
list_cardinality (h::t) = S (list_cardinality t)

-- Return the number of elements in s
-- set_cardinality: (s: set a) -> nat
-- relies on rep invariant
set_cardinality (mkSet l) = list_cardinality l
...
list_union: (eq a) => (s1: list a) -> (s2: list a) -> list a
list_union nil nil = nil
list_union nil (h2::t2) = (h2::t2)
list_union (h1::t1) nil = (h1::t1)
list_union (h1::t1) l = ite (member h1 l) (list_union t1 l) (h1:: (list_union t1 l))
...
set_union (mkSet l1) (mkSet l2) = mkSet (list_union l1 l2)
...
-- pair elt taks an elt h and a list b and returns list of all pairs,
...
tostringListVal (h::t) = (toString h) ++ "," ++ (tostringListVal t)
